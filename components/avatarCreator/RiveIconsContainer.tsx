...
export default function RiveIconsContainer() {
  return (
    <div className="md:gap-x-4 gap-x-2 w-full h-14 md:h-20 lg:h-24 bg-[#d7d6d6] dark:bg-[#1D1D1D] flex md:justify-between justify-center md:p-4 px-[12px] py-[4px] rounded-[16px] md:mx-auto">
