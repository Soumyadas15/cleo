  ...
  return (
    <aside>
      <Tabs
        ...
        className="h-screen overflow-y-scroll pb-24 scrollbar-hide"
      >
        ...
        <TabsContent
          value="actions"
          className="flex flex-col scrollbar-hide gap-4 p-4"
        >
          {Object.entries(EditorCanvasDefaultCardTypes)
            ...
            .map(([cardKey, cardValue]) => (
              <Card
                key={cardKey}
                draggable
                className="w-full cursor-grab border-neutral-200 bg-neutral-100 dark:border-neutral-700 dark:bg-neutral-900"
                onDragStart={(event) =>
