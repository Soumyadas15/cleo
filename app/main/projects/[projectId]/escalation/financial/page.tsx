...
const FinancialEscalationPage = async (
    ...
    const escalationMatrix = await getEscalationMatrix({ projectId: projectId, type: "FINANCIAL" });
...
export default FinancialEscalationPage;