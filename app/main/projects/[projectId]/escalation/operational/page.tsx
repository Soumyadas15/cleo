...
const OperationalEscalationPage = async (
    ...
    const escalationMatrix = await getEscalationMatrix({ projectId: projectId, type: "OPERATIONAL" });
...
export default OperationalEscalationPage;