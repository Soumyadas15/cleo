  ...
  return (
    <html lang="en" >
      <UserProvider>
        ...
        <body className={`${font.className} bg-black overflow-x-hidden transition `}>
        <ThemeProvider
            attribute="class"
            defaultTheme="light"
              ...
              <div>
                <div className="h-screen">
                  <div className=" w-full h-full flex items-center justify-between">
                    <div className="bg-white dark:bg-black transition duration-300 md:w-[15%] h-full flex items-center justify-center pr-1">
